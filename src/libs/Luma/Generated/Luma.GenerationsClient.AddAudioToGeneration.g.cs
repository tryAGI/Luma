...
namespace Luma
{
    public partial class GenerationsClient
    {
        ...
        private static readonly global::Luma.EndPointSecurityRequirement s_AddAudioToGenerationSecurityRequirement0 =
        ...
        private static readonly global::Luma.EndPointSecurityRequirement[] s_AddAudioToGenerationSecurityRequirements =
            new global::Luma.EndPointSecurityRequirement[]
            {                s_AddAudioToGenerationSecurityRequirement0,
            };
        ...
        {
            var __response = await AddAudioToGenerationAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Luma.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Luma.AutoSDKHttpResponse<global::Luma.Generation>> AddAudioToGenerationAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Luma.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddAudioToGenerationSecurityRequirements,
                operationName: "AddAudioToGenerationAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Luma.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Luma.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddAudioToGenerationAsync",
                                pathTemplate: "$\"/generations/{id}/audio\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Luma.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                throw global::Luma.ApiException<global::Luma.Error>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                {
                                    throw global::Luma.ApiException.Create(
                                        statusCode: __response.StatusCode,
