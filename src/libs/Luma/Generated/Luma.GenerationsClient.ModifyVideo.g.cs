...
namespace Luma
{
    public partial class GenerationsClient
    {
        ...
        {
            var __response = await ModifyVideoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Luma.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Luma.AutoSDKHttpResponse<global::Luma.Generation>> ModifyVideoAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Luma.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Luma.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ModifyVideoAsync",
                                pathTemplate: "\"/generations/video/modify\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
