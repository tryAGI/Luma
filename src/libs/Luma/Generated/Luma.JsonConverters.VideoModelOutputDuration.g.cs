...
namespace Luma.JsonConverters
{
    ...
    public class VideoModelOutputDurationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Luma.VideoModelOutputDuration>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Luma.VideoModelOutputDurationEnum), options);
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        videoModelOutputDurationVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsVideoModelOutputDurationVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.VideoModelOutputDurationVariant2!, typeInfo);
            }
        }
    }
}